...
pathcode <- str_c(path,"/Code/R code/Nature_R2")
...
source(str_c(pathcode,"/Module 6_Effects_Tax+SA_v5_recyshares_v2.R"))
source(str_c(pathcode,"/Module 7_Effects_TaxSA+GlobalFund_v4_recyshares.R"))
