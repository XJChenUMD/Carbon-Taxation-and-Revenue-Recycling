...
pathcode <- str_c(path,"/Code/Code_Long Paper_230213(SA_final)")
pathout <- str_c(path,"/results/Carbon taxatation and recycling_230213(SA_final)_inctax");dir.create(pathout)
